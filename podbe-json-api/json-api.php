<?php
/*
Plugin Name: Podbe Json-API 
Plugin URI: http://wordpress.org/extend/plugins/json-api/
Description: The Podbe RESTful API base by Dan Phiffers "Json Api" for WordPress
Version: 1.0.8
Author: Dan Phiffer, new dev for Podbe: Michael McCouman jr.
*/
...
function json_api_php_version_warning() {
  echo "<div id=\"json-api-warning\" class=\"updated fade\"><p>Sorry, PODBE JSON API requires PHP version 5.0 or greater.</p></div>";
}

function json_api_class_warning() {
  echo "<div id=\"json-api-warning\" class=\"updated fade\"><p>Oops, PODBE JSON_API class not found. If you've defined a JSON_API_DIR constant, double check that the path is correct.</p></div>";
}
